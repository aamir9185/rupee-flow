      ...
      />
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    <Link href="/expense-tracker" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
                        Expense
                    </Link>
                    <Link href="/gov-schemes" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
                        Schemes
                    </Link>
                    <Link href="/loans" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
                        Loan
                    </Link>
